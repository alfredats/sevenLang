...
public class ExternalChainingHashMap<K, V> {
    ...
    public V put(K key, V value) {
        ...
        int ind;
        V retVal;
        ExternalChainingMapEntry<K,V> keyvalPair;
        ...
        ind = Math.abs(keyhash % table.length);
        keyvalPair = new ExternalChainingMapEntry(key, value);

        if (table[ind] == null) {
          table[ind] = keyvalPair;
        } else {
    ...
    public V remove(K key) {
      ...
      if (table[ind] == null) {
        ...
        // check subsequent keys
        while (curr.getNext() != null) {
          if (curr.getNext().getKey() == key) {
            ExternalChainingMapEntry<K,V> dummy = curr.getNext();
