...
public class ArrayQueue<T> {
    ...
    public void enqueue(T data) {
      ...
      int modInd = (front + size) % backingArray.length;

      if (backingArray[modInd] != null && size >= backingArray.length) {
          // resize
    ...
    public T dequeue() {
      ...
      front = backingArray[newFront] == null ? front : newFront;
      size--;
