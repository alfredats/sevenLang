class AvlNode<T extends Comparable> {
  ...
  public final AvlNode<T> update() {
    Integer leftHeight = (null == this.getLeft()) ? NULL_CHILD_HEIGHT : this.getLeft().getHeight();
    Integer rightHeight = (null == this.getRight()) ? NULL_CHILD_HEIGHT : this.getRight().getHeight();
