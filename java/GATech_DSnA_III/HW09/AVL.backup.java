...
public class AVL<T extends Comparable<? super T>> {
  ...
  public void updateHeightAndBF(AVLNode<T> currentNode) {
    ...
    int lh = currentNode.getLeft() == null ? -1 : currentNode.getLeft().getHeight();
    int rh = currentNode.getRight() == null ? -1 : currentNode.getRight().getHeight();

    currentNode.setHeight(Math.max(lh, rh) + 1);
    currentNode.setBalanceFactor(lh - rh);
    return;
  }
